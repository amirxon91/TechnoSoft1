...
public class HomePage extends BasePage{
	...
	private By clickOnPasswordField = By.xpath("");
	private By clickOnRedError = By.xpath("");
	...
	public void clickOnPasswordTextField(){
		clickOn(clickOnPasswordField);
	}
	public void clickOnRedEror(){
		clickOn(clickOnRedError);
	}
